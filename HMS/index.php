        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Madonna Domiciliary Clinic</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:55px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Madonna Domiciliary Clinic</div>
      ...
      <div class="container">
        <div class="intro-main">
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                <h5>Health Check Up At Madonna Domiciliary Clinic</h5>
                <p>Madonna Domiciliary Clinic, in addition to providing world-class clinical lab services, it has a pool of specialists from various medical specialties who serve suffering patients as outpatients. They are all well-known and well-respected in their medical fields for excellent clinical management.</p>
                <ul class="row">
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                    <p>Madonna Domiciliary Clinic provide reliable communications and improve public safety areas. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>Madonna Domiciliary Clinic has licensed and qualified doctors! </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Madonna Domiciliary Clinic Supports Online Appointment. Check the appointment tab above. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>We offer free counseling to our patients. </p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row"> 
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We provide laboratory testing for both Clinical center inpatients and clinic outpatients. </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We provide antenatal care to pregnant mothers through our specialised nurses.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  <h6>Deliveries</h6>
                  <p>We provide effective delivery services to mothers giving birth to ensure the babies get delivered properly. </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We have specialised heath personnel who provide effective care and support to mothers after they have given birth.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We offer avariety of birth control methods to couples and individuals through our specialised medical personal.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  <h6>General Medical Care</h6>
                  <p>We provide a variety of general medical care services such as consultations and counselling.</p>
                </div>
              </article>
            </div>
          </div>
          ...
          <div role="tabpanel">
            <div class="dep-sec-nav"> 
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a href="#dental" role="tab" data-toggle="tab">Laboratory</a></li>
                <li role="presentation" class="active"><a href="#cardiology" role="tab" data-toggle="tab">Nursing </a></li>
                <li role="presentation"><a href="#for-disabled" role="tab" data-toggle="tab">Pharmacy </a></li>
                <li role="presentation"><a href="#ophthalmology" role="tab" data-toggle="tab">Nutrition </a></li>
            ...
            <div class="tab-content"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      ...
                      <p> It has survived not only three centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in 1990 and has been in place since then. <br>
                        <br>
                        It is managed by licensed specialists with extreme skills and great experiences.</p>
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/doctor.jpeg" alt="" >
                        <div class="name-doc">
                          <h6>DR.  DANIEL OKURUT</h6>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div role="tabpanel" class="tab-pane fade in active" id="cardiology"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best <span>NURSING</span> Services</h5>
                      <p> It has survived not only three centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in 1990 and has been in place since then. <br>
                        <br>
                        It is managed by licensed specialists with extreme skills and great experiences.</p>
                    ...
                    <!-- Doctor Img -->
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/mama.jpeg" alt="" >
                        <div class="name-doc">
                          <h6>NR. JANE ADONGO</h6>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div role="tabpanel" class="tab-pane fade" id="for-disabled"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best Services <span>PHARMACY</span> Persons </h5>
                      <p> It has survived not only three centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in 1990 and has been in place since then. <br>
                        <br>
                        It is managed by licensed specialists with extreme skills and great experiences. </p>
              ...
              <div role="tabpanel" class="tab-pane fade" id="ophthalmology"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best <span>NUTRITION</span> Services</h5>
                      <p> It has survived not only three centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in 1990 and has been in place since then. <br>
                        <br>
                        It is managed by licensed specialists with extreme skills and great experiences. </p>
