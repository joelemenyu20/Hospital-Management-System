...
<!-- Document Title -->
<title>Madonna Domiciliary Clinic</title>

<!-- Favicon -->
<link rel="shortcut icon" href="images/MDC1.png" type="image/x-icon">
<link rel="icon" href="images/MDC1.png" type="image/x-icon">
...
<div id="wrap">
  <div class="top-bar">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <p>Welcome To Madonna Domiciliary Clinic</p>
        </div>
        <div class="col-sm-6">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.php"><img src="images/MDC1.png" alt="" style="height: 52px;">Madonna Domiciliary Clinic</a> </div>
      <div class="head-info">
        <ul>
          <li> <i class="fa fa-phone"></i>
           <p>+256 760-937-621<br>
              +256 779-761-298</p>
          </li>
          <li> <i class="fa fa-envelope-o"></i>
            <p>amoroleah@gmail.com
              </p>
          </li>
